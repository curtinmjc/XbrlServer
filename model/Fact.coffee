class exports.Fact
  ...
  GetSeriesDescription: ->
    ...
    @seriesDescription = '[' + @doc['http://www.sec.gov/Archives/edgar/companyName'] + "]:" + @getValue(@doc['http://www.xbrl.org/2003/instance/Concept']) + (if not @IsDuration then "" else " -- " + @GetPeriodDescription()) + (if @GetDimensionsDescription() isnt '' then "<br/>" + @GetDimensionsDescription() else "")
    return @seriesDescription
  ...
  GetSeriesKey: ->
    ...
    @seriesKey = @doc['http://www.xbrl.org/2003/instance/Entity'] + ":" + @getValue(@doc['http://www.xbrl.org/2003/instance/Concept']) + (if not @IsDuration then "" else " -- " + @GetPeriodDescription()) + (if @GetDimensionsDescription() isnt '' then " -- " + @GetDimensionsDescription() else "")
    return @seriesKey
