...
(function() {
  ...
  $(function() {
    ...
    remove = function(arr, itemToRemove) {
      ...
      _results = [];
      for (num = _i = 0, _ref = arr.length; 0 <= _ref ? _i <= _ref : _i >= _ref; num = 0 <= _ref ? ++_i : --_i) {
        if (arr[num] === itemToRemove) {
          _results.push(arr.splice(num, 1));
        } else {
    ...
    populateChartInternal = function(docs) {
      var addedSeries, chartTitle, displayedSet, el, k, v, _i, _len;
      ...
      el.css('width', '100%');
      chartTitle = '';
      for (_i = 0, _len = displayedSets.length; _i < _len; _i++) {
        displayedSet = displayedSets[_i];
